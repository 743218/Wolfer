...
#include "../Client/Managers/ModuleManager/Modules/Category/Client/ClickGUI.h"
...
ID2D1SolidColorBrush* getSolidColorBrush(const WolferColor& color);
	...
	*/
	...
	// Eject
	{
		...
		if (showDuration > 0.1f) {
			...
			fillRectangle(underlineAnim, WolferColor(255, 255, 255));
			drawText(textPos, text, WolferColor(255, 255, 255), textSize);
		}
