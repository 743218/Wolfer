...
namespace Memory {
	...
	inline uintptr_t** getVtableFromSig(std::string_view sig) {
	...
	inline R CallFunc(void* func, Args... args) {
		return ((R(*)(Args...))func)(args...);
	}

	template <typename R, typename... Args>
	inline R CallFunc(uintptr_t func, Args... args) {
		return ((R(*)(Args...))func)(args...);
	}
