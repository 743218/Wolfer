...
public:
    MobEquipmentPacket(ActorRuntimeID runtimeId, ItemStack* itemStack, int32_t slot, int32_t selectedSlot, ContainerID containerId = ContainerID::Inventory) {
        ...
        static MobEquimentPacketConstructor_t MobEquimentPacketConstructor = reinterpret_cast<MobEquimentPacketConstructor_t>(Memory::findSig("48 89 5C 24 ? 48 89 74 24 ? 57 48 81 EC ? ? ? ? 41 8B F9 48 8B"));
