...
*/
    ...
    bool isAlive() {
        return Memory::CallVFunc<50, bool>(this);
    }

    ItemStack* getCarriedItem() {
        return Memory::CallVFunc<83, ItemStack*>(this);
    }

    void setOffhandSlot(ItemStack* itemStack) {
        Memory::CallVFunc<84, void, ItemStack*>(this, itemStack);
    }

    AnimationComponent* getAnimationComponent() {
        return Memory::CallVFunc<115, AnimationComponent*>(this);
    }
